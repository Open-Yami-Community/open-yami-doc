---
sidebar_position: 1
title: getTargetRandom 获取目标角色 - 随机
---
...
**位置**: [第 5760 行](https://github.com/Open-Yami-Community/open-yami-doc/blob/main/i18n/zh/docusaurus-plugin-content-docs/current/script/actor.ts#L5760)
