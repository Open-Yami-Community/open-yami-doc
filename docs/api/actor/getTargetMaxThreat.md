---
sidebar_position: 1
title: getTargetMaxThreat 获取目标角色 - 最大仇恨值
---
...
**位置**: [第 5547 行](https://github.com/Open-Yami-Community/open-yami-doc/blob/main/i18n/zh/docusaurus-plugin-content-docs/current/script/actor.ts#L5547)
