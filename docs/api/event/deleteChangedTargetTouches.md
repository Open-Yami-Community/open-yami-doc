---
sidebar_position: 1
title: deleteChangedTargetTouches 删除变动的目标元素触摸点
---

## deleteChangedTargetTouches
...
**位置**: [第 1460 行](https://github.com/Open-Yami-Community/open-yami-doc/blob/main/i18n/zh/docusaurus-plugin-content-docs/current/script/event.ts#L1460)
