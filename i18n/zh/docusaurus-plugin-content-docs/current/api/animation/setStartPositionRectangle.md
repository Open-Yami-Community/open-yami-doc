---
sidebar_position: 1
title: setStartPositionRectangle 设置初始位置 - 矩形发射区域
---
...
**位置**: [第 2338 行](https://github.com/Open-Yami-Community/open-yami-doc/blob/main/i18n/zh/docusaurus-plugin-content-docs/current/script/animation.ts#L2338)
