---
sidebar_position: 1
title: compileCommandTupleInNamespace 编译带命名空间的子事件指令函数元组
---
...
**位置**: [第 3953 行](https://github.com/Open-Yami-Community/open-yami-doc/blob/main/i18n/zh/docusaurus-plugin-content-docs/current/script/command.ts#L3953)
